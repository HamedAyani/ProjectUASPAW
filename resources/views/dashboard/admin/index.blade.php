...
<div class="mt-3 mb-2">
    ...
    <form class="mb-2" action="{{ url('dashboard/admin') }}" method="GET">
    ...
    {{-- <div class="table-responsive"> --}}
        <table  class="table table-striped jambo_table bulk_action" style="text-align:center">
            ...
            <tr>
                ...
                <td style="text-align:center"><a class="btn btn-warning btn-sm" href="{{ url('dashboard/admin/'.$value->isbn.'/edit') }}">Edit Stock</a></td>
